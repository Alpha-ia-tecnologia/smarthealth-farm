...
export const navItems: NavItem[] = [
  ...
  { to: "/notas-fiscais", label: "Notas Fiscais", icon: ReceiptText, rf: "RF-DAD", grupo: "Operação", desc: "Importação de NF-e (XML) e extração de dados" },
  ...
  { to: "/integracao", label: "Integração", icon: Plug, rf: "RF-INT", grupo: "Governança", desc: "Conexões com EMSERH, WhatsApp, Telegram e e-mail" },
